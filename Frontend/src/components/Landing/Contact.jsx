  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      content: 'support@resumebuildr.com',
      link: 'mailto:support@resumebuildr.com'
    },
    {
                ...
                {supportChannels.map((channel, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="p-3 bg-gradient-to-br from-blue-100 to-purple-100 text-blue-600 rounded-lg mr-4 group-hover:scale-110 transition-transform">
                          {channel.icon}
                        </div>
                        <div>
                          <h4 className="font-semibold text-gray-900">{channel.title}</h4>
                          <p className="text-gray-600 text-sm">{channel.description}</p>
                          <span className="text-green-600 text-xs font-medium">{channel.availability}</span>
                        </div>
                      </div>
