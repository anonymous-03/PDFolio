        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <button className="px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-full hover:border-gray-400 transition-all duration-300 flex items-center gap-2">
          ...
          <div className="bg-white rounded-full shadow-lg px-8 py-4 flex items-center gap-8">
            ...
            <div className="border-l pl-8">
              ...
              <p className="text-sm text-gray-600">
                Trusted by <span className="font-semibold">10,000+</span> professionals
              </p>
            </div>
          </div>
        </motion.div>
