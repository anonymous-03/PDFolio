...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Choose from 50+ professional templates and customize colors, fonts, and layouts. Add sections, rearrange content, and make it truly yours.',
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our streamlined process takes you from upload to live portfolio in under 3 minutes. 
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold">3 min average</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="px-8 py-4 bg-white text-gray-700 font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-2">
